...
public class TalkManager : MonoBehaviour
{
    ...
    private void GenerateData()
    {
        ...
        "플레이어 : 아닙니다. 제가 나고 자란 고향인데 그럴 수는 없습니다.", "플레이어 : 제가 일단 마을을 순찰하고 올게요!","장로 : 정말 고집불통이로군....살아 돌아오게.","독백 : 마을을 순찰해보자..."});
        ...
        "장로 : 인간들이 없는 마을을 차지하고 싶겠지....다친 곳은 없는가?","플레이어 : 주신 약초액을 마시며 쉬었더니 자잘한 상처들은 다 나았습니다.","장로 : 그렇지? 내가 오랜 시간 책을 보며 연구한 약초일세, 뿌듯하구만.","독백 : 어떤 책일까?",
        "장로 : 고블린들이 오고 있다니 나는 그럼 마을 입구들의 문들을 단속하고 오겠네","플레이어 : 저는 그럼 재정비하며 이곳에서 기다리겠습니다.","장로 : 집에서 쉬지 않고?","플레이어 : 집에는 음식과 씻을 물이 다 떨어졌습니다.","장로 : 아 그럴 수 있지, 그럼 쉬고 있게나!",
        "독백 : 장로가 잠시 자를 비운 사이에 특이사항이 없는지 회관을 둘러보자."});
        talkData.Add(41 + 200, new string[] { "독백 : 안지 오래되었지만 장로님의 집에 들어온 것은 처음이다.","독백 : 일단 수상한 것이 있는지 찾아보자....책을 보고 만들었다고 했는데....","독백 : 수상하게 보이는 상자다...한 번 열어보자." });
    }
