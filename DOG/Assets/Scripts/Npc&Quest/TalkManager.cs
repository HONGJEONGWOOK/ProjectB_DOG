...
public class TalkManager : MonoBehaviour
{
    ...
    private void GenerateData()
    {
        ...
        "주민 : 저는 그러면 마을 사람들이 돌아왔을 때를 대비해서 "});
        talkData.Add(61 + 3000, new string[] { "독백 : 이럴 수가 상자가 그 사이에 사라졌다.","독백 : 그럼 장로가 그 사이에 회관으로 다시 와서 어디론가 가져간 것이겠지.","장로 : 눈치를 챘나....흐흐흐","플레이어 : 당신!....어디서 말을 하는 거지? 주민들은 어디있어!",
