...
public class TalkManager : MonoBehaviour
{
    ...
    private void GenerateData()
    {
        ...
        "플레이어 : 아닙니다. 제가 나고 자란 고향인데 그럴 수는 없습니다.", "플레이어 : 제가 마을을 순찰하고 올게요!","장로 : 정말 고집불통이로군....살아 돌아오게.","시스템 : 마을을 순찰해보자..."});
        ...
        "주민 : 저는 장로를 피해 지금 이곳에 숨은 거에요.","플레이어 : 계속 숨어계십시오, 제가 상황을 파악해보겠습니다.","주민 : 부디...조심하세요.","시스템 : 다시 장로에게 돌아가보자."});

        talkData.Add(20 + 1000, new string[] { "주민 : 바쁘지 않으면 꽃을 하나 구해줄 수 있니?" });
        talkData.Add(21 + 3000, new string[] { "독백 : 이 꽃을 가져가자." }); //npc와 대화를 하는 것처럼 꽃도 대화를 걸어서 퀘스트를 완료하는 방식으로 함
        talkData.Add(22 + 2000, new string[] { "주민 : 고마워...", "주민 : 증거는 없지만...장로에게 비밀이 있는 것 같아" });
